...
export const MediaPage: React.FC = () => {
  ...
  const mediaItems: MediaItem[] = [
    ...
    {
      id: 'm1',
      title: 'Pickup Basketball with Friends',
      category: 'Sports & Action',
      type: 'image',
      url: '/src/assets/images/basketball_court_sunset_1790100453864.jpg',
      caption: 'Playing outdoor basketball with friends at sunset after high school classes.',
      date: 'Sept 2026',
      isPlaceholder: false,
    },
    {
      id: 'm2',
      title: 'Soccer Matches & Ronaldo Inspiration',
      category: 'Sports & Action',
      type: 'image',
      url: '/src/assets/images/soccer_ronaldo_celebrate_1790100465423.jpg',
      caption: 'Competitive weekend soccer with friends, inspired by Cristiano Ronaldo, the GOAT.',
      date: 'Sept 2026',
      isPlaceholder: false,
    },
    {
